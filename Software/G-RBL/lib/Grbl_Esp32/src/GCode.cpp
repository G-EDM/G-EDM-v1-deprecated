            ...
            case 'M':
                ...
                switch (int_value) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        // used to lower the z axis again after a toolpath change
                        planner.z_axis_down();
                        break;
                    case 5:
                        switch (int_value) {
                    ...
                    case 7:
                        ...
                        sys.gedm_single_axis_drill_task = !sys.gedm_single_axis_drill_task;
                        break;
                    case 8:
                        sys.gedm_single_axis_drill_task = false;
                        sys.gedm_floating_z_gcode_task  = !sys.gedm_floating_z_gcode_task;
                        break;

                    case 9:
                        sys.gedm_single_axis_drill_task = false;
                        sys.gedm_floating_z_gcode_task  = false;
                        sys.gedm_wire_gcode_task        = !sys.gedm_wire_gcode_task;
                        break;
